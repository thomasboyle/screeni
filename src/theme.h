...
inline QString globalStyleSheet()
{
    ...
    QString s = QStringLiteral(
        ...
        "QComboBox { background: %32; color: %33; border: 1px solid %34; border-radius: 4px; padding: 4px 8px; min-height: 28px; }"
        "QComboBox::drop-down { border: none; width: 20px; }"
        "QComboBox QAbstractItemView { background: %32; color: %33; border: 1px solid %34; selection-background-color: %35; outline: none; }"

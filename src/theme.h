...
inline QString globalStyleSheet()
{
    ...
    QString s = QStringLiteral(
        ...
        "QFrame#sidebar QPushButton#nav { color: %36; background: transparent; border: none; outline: none; border-radius: 4px; text-align: center; padding: 0 14px; min-height: 44px; }"
        "QFrame#sidebar QPushButton#nav:hover { background-color: %38; color: %40; }"
        "QFrame#sidebar QPushButton#nav[navSelected=\"true\"] { background-color: %39; color: %42; border: none; outline: none; border-left: 4px solid %41; border-right: 4px solid %41; border-radius: 4px; text-align: center; padding: 0 10px; min-height: 44px; }"
